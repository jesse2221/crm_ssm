			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="javascript:void(0)" id="myInfo"><span class="glyphicon glyphicon-file"></span>
							我的资料</a></li>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div style="position: relative; width: 55%; height: 70%; left: 22%;">
			...
			<div style="position: relative; width: 33%; height: 50%;">
				...
				<a href="settings/dept/index.do" style="text-decoration: none; ">部门管理</a>
				<br>
				<a href="settings/qx/index.do" style="text-decoration: none; ">权限管理</a>
			</div>
