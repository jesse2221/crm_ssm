...
<body>
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			...
			-60px;"><b>${contacts.fullname}${contacts.appellation}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		...
		<c:forEach items="${remark}" var="r">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<small
						style="color:
					gray;"> ${r.editFlag=='0'?r.createTime:r.editTime}
						由${r.editFlag=='0'?r.createBy:r.editBy}${r.editFlag=='0'?'创建':'修改'}</small>
		...
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable3" class="table table-hover" style="width: 900px;">
					...
					<tbody>
						<tr>
							<td><a href="transaction/detail.jsp" style="text-decoration: none;">lsx毕设-交易01</a></td>
							<td>5,000</td>
							<td>谈判/复审</td>
							<td>90</td>
							<td>2022-04-08</td>
