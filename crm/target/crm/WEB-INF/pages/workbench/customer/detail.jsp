...
<body>
	...
	<div style="position: relative; top: 10px; left: 40px;">
		...
		<!-- 备注1 -->
		<c:forEach items="${customerRemarkList}" var="list">
			<div id="div_${list.id}" class="remarkDiv" style="height: 60px;">
				<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5>${list.noteContent}</h5>
					<font color="gray">客户</font> <font color="gray">-</font> <b>${customer.name}</b> <small
						style="color: gray;">
					${list.editFlag=='0'?list.createTime:list
					.editTime}由${list.editFlag=='0'?list.createBy:list.editBy}${list.editFlag=='0'?'创建':'修改'}</small>
					<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
						<a class="myHref" name="editA"  customerId="${list.id}" href="javascript:void(0);"><span
								class="glyphicon glyphicon-edit"
																			style="font-size: 20px; color: #E6E6E6;"></span></a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="myHref" name="deleteA" customerId="${list.id}" href="javascript:void(0);"><span
		...
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable2" class="table table-hover" style="width: 900px;">
					...
					<tbody>
						<tr>
							<td><a href="transaction/detail.jsp" style="text-decoration: none;">林师雄毕设-交易01</a></td>
							<td>5,000</td>
							<td>谈判/复审</td>
							<td>90</td>
							<td>2022-05-07</td>
		...
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable" class="table table-hover" style="width: 900px;">
					...
					<tbody>
						<tr>
							<td><a href="contacts/detail.html" style="text-decoration: none;">林师雄</a></td>
							<td>476825496@qq.com</td>
							<td>13543645364</td>
