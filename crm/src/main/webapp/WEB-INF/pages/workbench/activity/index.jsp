			...
			$.ajax({
				...
				success: function (data) {
					if (data.code == 1) {
						...
						queryActivityByConditionForPage(1, $("#activity_pagination").bs_pagination('getOption', 'rowsPerPage'))
					} else {
						//提示信息
						alert(data.message);
						//不关闭模态窗口
			...
			$.ajax({
				...
				success:function (data) {
					if(data.code=="1"){
						...
						queryActivityByConditionForPage($("#activity_pagination").bs_pagination('getOption','currentPage'),$("#activity_pagination").bs_pagination('getOption','rowsPerPage'))
					}else {
						alert(data.message);
						$("#editActivityModal").modal("show");
					}
	...
	function queryActivityByConditionForPage(pageNo,pageSize) {
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data.activitiesList,function (index,n) {
					html+='<tr class="active">',
							html+='<td><input type="checkbox" name="xz" value="'+n.id+'"/></td>',
							html+='<td><a style="text-decoration: none; cursor: pointer;"onclick="window.location.href=\'workbench/activity/queryActivityForDetail.do?id='+n.id+'\';">'+n.name+'</a></td>',
							html+='<td>'+n.owner+'</td>',
				...
				$("#activity_pagination").bs_pagination({
			...
			<div class="modal-body">
				...
				<form id="createActivityForm" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<label for="create-endDate" class="col-sm-2 time control-label" >结束日期</label>
						<div class="col-sm-10" style="width: 300px;">
...
<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
	...
	<%--		<div>--%>
	<%--			<button type="button" class="btn btn-default" style="cursor: default;">共<b id="BID">50</b>条记录</button>--%>
	<%--		</div>--%>
