...
<script type="text/javascript">
	$(function () {
		...
		$("#create-stage").change(function () {
			...
			// var value=$("#create-stage option:selected").text();
			//表单验证
			if(stageValue==""){
				//清空可能性输入框
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			<label for="create-name" class="col-sm-2 control-label">名称<span style="font-size: 15px; color: red;">*
			</span></label>
			<div class="col-sm-10" style="width: 300px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" value="e096ab0cc7354d8b8cf323a4906930f3" id="create-activityId">
				<input type="text" class="form-control" id="create-activitySrc" value="测试03">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="text" class="form-control" id="create-contactsName" value="林师雄">
			</div>
		</div>
